...
public class Author
{
    ...
    public Author()
    {
        init(null, null, new Date(), new Name());
    } // end constructor
    ...
    public Author(String firstName, String lastName, String middleName,
        ...
        String pseudoFirst, String pseudoLast, String pseudoMiddle
    ) {
        ...
        // To the observer:
        // This may be the first time you've seen what is known as "the ternary operator".
        // It takes the form A ? B : C, where A is a true/false evaluation,
        // B is the true consequence, and C is the false consequence.
        // It's like an if/else, except it can be used as part of another operation.
        this.pseudonym = (
            (null != pseudoFirst
                || null != pseudoLast
                || null != pseudoMiddle
            )
            ? new Name(pseudoFirst, pseudoLast, pseudoMiddle)
            : null
        );
    } // end constructor
     ...
     * @param died      Date the author kicked the bucket [optional: null means "hasn't died yet"]
     */
    protected void init(Name name, Date born, Date died, Name pseudonym)
    {
        // The behavior of these ternary operators ( ? : ) is described in the second constructor, above.
     ...
     */
    public void getDateBorn(Date born)
    {
        this.born = born;
    } // end accessor
     ...
     */
    public void getDateDied(Date died)
    {
        this.died = died;
    } // end accessor
     ...
     */
    public void getPseudonym(Name pseudonym)
    {
        this.pseudonym = pseudonym;
    } // end accessor
} // end class
