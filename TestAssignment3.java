...
public class TestAssignment3 {
    ...
    public TestAssignment3() {
        ...
        System.out.println(1 == bookStore.howManyBooksDidThisAuthorWrite("lawrEnce"));
        ...
        System.out.println(8 == titles.length);

        String[] titles2 = bookStore.getBookTitlesContaining("SON");
        System.out.println(1 == titles2.length);
    ...
    public static void main(String[] args) {
        TestAssignment3 obj = new TestAssignment3();
    }
}
